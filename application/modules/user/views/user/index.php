...
renderHeader('Users', true, true,
    [
        ...
        'buttons' => [
            ['class' => 'plus-button', 'name' => 'create', 'value' => '', 'formaction' => '/no_framework/user/create', 'iconClass' => 'plus-icon', 'iconSrc' => '/no_framework/public/images/icons/iconmonstr-user-23.svg', 'alt' => 'Add', 'tooltip' => 'Add']
        ]
    ],
    [
        'inputFields' => [
        ...
        'buttons' => [
            ['class' => 'minus-button', 'name' => 'delete', 'value' => '', 'formaction' => '/no_framework/user/delete', 'iconClass' => 'minus-icon', 'iconSrc' => '/no_framework/public/images/icons/iconmonstr-user-27.svg', 'alt' => 'Remove', 'tooltip' => 'Remove']
        ]
    ]
);
